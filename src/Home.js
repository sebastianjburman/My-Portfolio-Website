...
function Home(props) {
    return (
        <div className = "homeDiv">
            <img  className = "sebastianImage" src = {sebastianImage}></img>
            ...
            <div className = "iconContainer">
                <a href="https://github.com/sebastianjburman" target="_blank">
                ...
                <a href= "https://www.linkedin.com/in/sebastian-burman-62118b203/" target = "_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        width="24" height="24"
                        viewBox="0 0 24 24">
