    ...
    return (
        <div className="projectCardContainer">
            ...
            <div className="hoverOn">
                ...
                {/*If no website link show no live preview */}
                {props.website ? <a className="visitWebsiteLink" href={props.website} rel="noreferrer" target="_blank">Visit Website</a> : <p className="cardNolivePreviewP">No Live Preview</p>}
