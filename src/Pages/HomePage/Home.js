    ...
    return (
        <div className="homeDiv">
            ...
            <div className="iconContainer">
                <a href="https://github.com/sebastianjburman" rel="noreferrer" target="_blank">
                ...
                <a href="https://www.linkedin.com/in/sebastian-burman-62118b203/" rel="noreferrer" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24"
                        viewBox="0 0 24 24">
            ...
            <div className="recentProjects">
                ...
                {props.allProjects.slice(0, 4).reverse().map(x => {
                    return <ProjectCard key={x.projectId} name={x.name}
